...
if __name__ == "__main__":
    ...
    output_file: Path = Path("/home/lbuigues001/TFM/qwen/faltan_CoT1_CAT.jsonl").resolve()
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        for idx, row in enumerate(df.itertuples(), 1):
            ...
            prompt: str = f"""Traduce el siguiente extracto de un texto informal del catalán al español. El texto incluye podcasts y entrevistas informales publicadas en YouTube.

...
if __name__ == "__main__":
    ...
    output_file: Path = Path("/home/lbuigues001/TFM/translategemma/output_CoT2_ES.jsonl").resolve()
...
Also, follow these 3 steps before translating:
1. Analyze the context to understand intent, tone and implied meaning.
2. Identify the informal registration marks in the text to be translated.
3. Translate the text taking into account the previous steps.

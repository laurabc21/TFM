...
if __name__ == "__main__":
    ...
    output_file: Path = Path("/home/lbuigues001/TFM/translategemma/output_CoT2_CAT.jsonl").resolve()
...
Se añade también texto anterior y posterior al extracto para ayudarte a comprender mejor el contexto. Produce una traducción natural y asegúrate de que mantenga el tono y registro coloquial.
 Además, sigue estos 3 pasos antes de traducir:
1. Analiza el contexto para comprender la intención, el tono y el significado implícito.
2. Identifica las marcas de registro informal en el texto a traducir.
3. Traduce el texto teniendo en cuenta los pasos anteriores.

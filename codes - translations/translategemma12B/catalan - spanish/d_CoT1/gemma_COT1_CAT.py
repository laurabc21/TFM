...
if __name__ == "__main__":
    ...
    output_file: Path = Path("/home/lbuigues001/TFM/translategemma/output_CoT1_CAT.jsonl").resolve()
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        for idx, row in enumerate(df.itertuples(), 1):
            ...
            prompt = f"""TTraduce el siguiente extracto de un texto informal del catalán al español. El texto incluye podcasts y entrevistas informales publicadas en YouTube.
Se incluye texto antes y después del extracto para ayudarte a comprender mejor el contexto. Piensa paso a paso en la traducción para asegurarte de mantener el tono y el registro coloquial.

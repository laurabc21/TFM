...
if __name__ == "__main__":
    ...
    output_file = Path("/home/lbuigues001/TFM/salamandraTA/output_CAT_CoT1.jsonl").resolve()
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        for idx, row in enumerate(df.itertuples(), 1):
            ...
            text = f"""Traduce el siguiente extracto de un texto informal del catalán al español. El texto incluye podcasts y entrevistas informales publicadas en YouTube.
